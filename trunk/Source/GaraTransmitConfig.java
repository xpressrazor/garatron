//GaraTransmitConfig.java


import java.io.*;
import java.util.*;

public class GaraTransmitConfig
{
    ...
    public void read()
    {
        ...
        try
        {
			...
			for( int i= 0; i < n_targets; i++)
			{
				...
				targets.addElement( new GaraTarget( local_data_port, ip, port));
	    	}
    ...
    {
		targets.addElement( new GaraTarget( "", ip, port));
    }
}
