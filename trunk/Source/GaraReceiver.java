...
public class GaraReceiver implements ReceiveStreamListener, SessionListener,
	ControllerListener, RemoteListener
{
    ...
    public GaraReceiver( Garatron rgaratron, Vector targets)
    {
		this.rgaratron= rgaratron;
    ...
    public void removeTarget( String address, String port)
    {
		...
		for (int i = 0; i < mgrs.size(); i++)
		{
			...
			&& port.equals( dataPort))
			{
				...
				mgr.removeTarget( addr, "Closing session from GaraReceiver");
				mgr.dispose();
    ...
    protected void close()
    {
		...
		for (int i = 0; i < mgrs.size(); i++)
		{
			...
			mgr.removeTargets( "Closing session from GaraReceiver");
			mgr.dispose();
			mgr = null;
		}
    }
    ...
    public synchronized void update( ReceiveStreamEvent evt)
    {
		...
		else if (evt instanceof ByeEvent)
		{
			...
			//rgaratron.rtcpReport( sb.toString());
    ...
    public synchronized void controllerUpdate(ControllerEvent ce)
    {
		...
		if (ce instanceof ControllerErrorEvent)
		{
			...
			System.err.println("GaraReceiver internal error: " + ce);
		}
    }
